...
export function registerTaskRoutes(app: Express, wss: WebSocketServer): void {
  ...
  app.post("/api/v1/chat/completions", (req, res) => { controller.chatCompletions(req, res); });
  ...
  app.patch("/api/v1/tasks/filewise/:runId/modules", (req, res) => { controller.updateModules(req, res); });
  app.patch("/api/v1/tasks/filewise/:runId/rag", (req, res) => { controller.bindRagKnowledgeBase(req, res); });
